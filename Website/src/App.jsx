...
function Icon({ name, size = 24, ...props }) {
  const paths = {
    ...
    pin: <><path fill="currentColor" stroke="none" d="M12 2a8 8 0 0 0-8 8c0 6 8 13 8 13s8-7 8-13a8 8 0 0 0-8-8Z"/><circle cx="12" cy="10" r="3" fill="white" stroke="none"/></>,
    document: <><path d="M5 2h10l4 4v16H5zM15 2v5h4M8 11h8M8 15h8M8 19h8"/></>,
    people: <><circle cx="12" cy="7" r="3" fill="currentColor"/><circle cx="4" cy="9" r="2" fill="currentColor"/><circle cx="20" cy="9" r="2" fill="currentColor"/><path fill="currentColor" d="M7 21v-3a5 5 0 0 1 10 0v3ZM1 19v-2a4 4 0 0 1 5-4M23 19v-2a4 4 0 0 0-5-4"/></>,
    headset: <><path d="M3 14v-3a9 9 0 0 1 18 0v6a5 5 0 0 1-5 5h-3"/><rect x="1" y="10" width="4" height="9" rx="2" fill="currentColor"/><rect x="19" y="10" width="4" height="9" rx="2" fill="currentColor"/></>,
    building: <><path d="M3 22h18M6 22V5l6-3 6 3v17M10 22v-5h4v5M9 7h1m4 0h1M9 11h1m4 0h1M9 15h1m4 0h1"/></>,
    card: <><rect x="1" y="4" width="22" height="16" rx="2" fill="currentColor"/><circle cx="7" cy="10" r="2" fill="white" stroke="none"/><path d="M4 16a3 3 0 0 1 6 0" stroke="white"/><path d="M14 9h6m-6 4h6m-6 4h4" stroke="white"/></>,
    chart: <><path d="M1 22h22"/><rect x="3" y="12" width="4" height="9" rx="1" fill="currentColor"/><rect x="10" y="7" width="4" height="14" rx="1" fill="currentColor"/><rect x="17" y="1" width="4" height="20" rx="1" fill="currentColor"/></>,
  ...
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>{paths[name] || paths.document}</svg>
}
Icon.propTypes = { name: PropTypes.string.isRequired, size: PropTypes.number }
function Fingerprint({ className = '' }) {
  return <svg className={className} viewBox="0 0 64 72" fill="none" aria-hidden="true"><g stroke="currentColor" strokeWidth="2.7" strokeLinecap="round"><path d="M5 30C5 1 50-8 59 23M3 40C16 37 5 16 28 10c18-4 29 10 28 23M8 49c15-5 3-30 23-33 16-3 21 10 18 24-3 15-10 20-17 26M3 57c24-9 10-30 27-35 13-4 17 8 12 22-4 13-13 18-20 21M10 62c18-10 12-24 16-31 4-8 13-4 11 5-2 13-9 21-15 24M30 35c-1 9-4 16-10 20M42 65c10-10 15-23 15-29M4 22C9 9 17 4 27 3M35 3c9 0 17 5 21 12"/></g><path d="m33 66 20-16 3 7-17 14Z" fill="#fbd51a"/><path d="m42 66 13-9 3 7-6 1-1 7Z" fill="#e51b2b"/></svg>
}
Fingerprint.propTypes = { className: PropTypes.string }
const articles = [
  { image: 'outreach', category: 'ACTUALITÉ', date: '12 avril 2025', title: 'L’ONIP rapproche ses services des populations de l’intérieur', body: 'L’identification se rapproche des citoyens grâce au déploiement des équipes d’enrôlement dans les territoires. Cette démarche vise à rendre les services accessibles à toutes les populations.' },
  { image: 'center', category: 'INSTITUTION', date: '08 avril 2025', title: 'Inauguration d’un nouveau centre d’enrôlement à Mbuji-Mayi', body: 'Un nouveau centre d’enrôlement accueille les citoyens à Mbuji-Mayi. Il accompagne les habitants dans les différentes étapes de leur identification.' },
  { image: 'identity', category: 'SOCIÉTÉ', date: '28 mars 2025', title: 'Tout savoir sur la nouvelle carte d’identité nationale', body: 'La carte d’identité nationale permet d’attester votre identité. Découvrez les étapes de l’enrôlement et les informations utiles pour préparer votre démarche.' },
]
const services = [
  { icon: 'pin', title: 'Trouver un centre', description: <>Localisez le centre d’enrôlement <br/>le plus proche de vous.</>, body: 'Les centres d’enrôlement vous accompagnent dans votre démarche d’identification. La carte et les adresses des centres seront disponibles après connexion au répertoire officiel.' },
  { icon: 'document', title: 'Suivre ma demande', description: <>Consultez l’état d’avancement <br/>de votre demande.</>, body: 'Saisissez le numéro figurant sur votre récépissé d’enrôlement.' },
  { icon: 'people', title: 'Conditions d’enrôlement', description: <>Découvrez les conditions et les <br/>pièces à fournir.</>, body: 'Préparez les documents attestant votre identité et présentez-vous dans un centre d’enrôlement. La liste officielle des pièces et les conditions d’éligibilité seront publiées ici après validation par l’ONIP.' },
  { icon: 'headset', title: 'Assistance', description: <>Besoin d’aide ? <br/>Nous sommes à votre écoute.</>, body: 'Retrouvez les réponses aux questions fréquentes sur l’identification, les centres et le suivi des demandes. Les coordonnées du service d’assistance seront ajoutées après validation.' },
]
const slides = [
  { title: <>Une identité sécurisée<br/>pour chaque Congolais</>, text: <>L’ONIP construit une identité fiable, inclusive<br className="desktop-break"/> et accessible à tous.</>, image: 'hero' },
  { title: <>L’identification, plus proche<br/>de chez vous</>, text: <>Des services de proximité pour accompagner<br className="desktop-break"/> chaque citoyen dans ses démarches.</>, image: 'outreach' },
